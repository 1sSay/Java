...
public class Divide extends Operation {
    public Divide(final AllExpression value1, final AllExpression value2) {
        super(value1, value2);
    }

    @Override
    public int hashCode() {
        return value1.hashCode() + value2.hashCode() * 143;
    }
    ...
    public BigInteger evaluate(BigInteger x) {
        return value1.evaluate(x).divide(value2.evaluate(x));
    }

//    @Override
//    public BigInteger evaluate(BigInteger x, BigInteger y, BigInteger z) {
//        return value1.evaluate(x, y, z).divide(value2.evaluate(x, y, z));
//    }
}
